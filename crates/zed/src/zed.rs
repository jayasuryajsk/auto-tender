...
use gpui::{WindowBounds, Bounds, size};
...
pub fn build_window_options(display_uuid: Option<Uuid>, cx: &mut App) -> WindowOptions {
    ...
    // Always use a standard windowed mode for initial creation
    // We'll explicitly maximize it after workspace initialization
    WindowOptions {
...
pub fn initialize_workspace(
    ...
    cx.observe_new(move |workspace: &mut Workspace, window, cx| {
        ...
        // Force maximize window on startup
        window.zoom_window();
